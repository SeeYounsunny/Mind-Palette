...
const ColorDiaryApp = () => {
  ...
  const weatherFeelings = {
    '맑음 ☀️': ['상쾌함', '활기참', '밝음', '따뜻함', '기분좋음', '에너지충만', '기타'],
  ...
  if (showCalendar) {
    ...
    return (
      <>
        ...
        <div style={{ fontFamily: "'Nanum Gothic', 'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif" }} className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-6">
  ...
  return (
    <>
      <link href="https://fonts.googleapis.com/css2?family=Nanum+Gothic:wght@400;700;800&display=swap" rel="stylesheet" />
      <div style={{ fontFamily: "'Nanum Gothic', 'Apple SD Gothic Neo', 'Malgun Gothic', sans-serif" }} className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg p-6 min-h-96">
